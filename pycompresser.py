...
#add compilement stats /chosen offset/time taken etc...
#don't table len 1 tokens
#publish it on pypi
...
class Compresser:
    ...
    def compress(script,chars_offset=offset):
    ...
    def compile(file,offset=offset):
        ...
        aqua+=f"table={table}.split({repr(n)})\n"
...
if __name__=='__main__':
    ...
    try:
        ...
        with open(write_to,"w",encoding="utf-8") as compressed:
            ...
            aqua=Compresser.brute_force_compile(file_text,iterations=64)
        ...
        raise (error)
        print("Command usage shoud be \"python pycompresser.py file_to_compress.py new_file.py\".")